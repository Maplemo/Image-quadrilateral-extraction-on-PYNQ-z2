...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:ImgProjection:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ImgProjection_0, and set properties
  set ImgProjection_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ImgProjection:1.0 ImgProjection_0 ]
  ...
  connect_bd_intf_net -intf_net ImgProjection_0_out_stream [get_bd_intf_pins ImgProjection_0/out_stream] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins ImgProjection_0/in_stream] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ImgProjection_0/s_axi_CONTROL_BUS/Reg] SEG_ImgProjection_0_Reg
